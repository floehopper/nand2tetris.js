...
AST.Inputs = function(busses) {
  this.busses = busses;
};

AST.Inputs.prototype.toDefinition = function() {
  return this.busses.reduce(function(arr, bus) { return arr.concat(bus.toDefinition()); }, []);
};

AST.Outputs = function(busses) {
  this.busses = busses;
};
